...
@Config
@Disabled
public class ClimbTestTwo extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive() && !isStopRequested()) {
            if (gamepad1.triangle) {
                lift.slides1.setSpeed(1);
                lift.slides2.setSpeed(-1);
            } else if (gamepad1.cross) {
               lift.slides1.setSpeed(1);
                lift.slides2.setSpeed(-1);
            } else {
                lift.slides1.setSpeed(0);
                lift.slides2.setSpeed(0);
            }
