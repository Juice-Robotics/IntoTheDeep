...
public final class TuningOpModes {
    public static final Class<?> DRIVE_CLASS = KalmanDrive.class; // TODO: change to your drive class i.e. PinpointDrive if using pinpoint
...
//                ext.runToPosition(120);
                ...
                parEncs.add(new PinpointEncoder(pd.pinpoint,false,(DcMotor) pd.leftBack));
                perpEncs.add(new PinpointEncoder(pd.pinpoint,true, (DcMotor) pd.leftBack));
