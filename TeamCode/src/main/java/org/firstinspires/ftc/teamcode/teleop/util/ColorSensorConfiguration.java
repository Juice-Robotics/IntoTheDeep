...
public class ColorSensorConfiguration extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        crf.setPin0DigitalMaxDistance(ColorRangefinder.DigitalMode.HSV, 30); // 5mm or closer requirement
        ...
        crf.setPin1DigitalMaxDistance(ColorRangefinder.DigitalMode.HSV, 30); // 5mm or closer requirement
